            ...
            <>
              ...
              <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <label className="block">
                  <span className="text-xs font-medium text-ink-500">Invoice date</span>
                  <input
                    type="date"
                    value={invoiceDate}
                ...
                <label className="block">
                  <span className="text-xs font-medium text-ink-500">Invoice no.</span>
                  <input
                    value={reference}
              ...
              <label className="mt-8 block max-w-xl">
                <span className="text-xs font-medium text-ink-500">Message on invoice</span>
                <textarea
                  value={notes}

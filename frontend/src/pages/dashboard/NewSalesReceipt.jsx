...
import { X, Plus, AlertCircle, Receipt, ShoppingBag, Download, Printer, Mail } from 'lucide-react'
...
export default function NewSalesReceipt() {
  ...
  const submit = async ({ andNew, andPrint }) => {
    ...
    if (andPrint) {
      ...
      navigate(`/dashboard/sales/new-receipt/${savedId}`, { replace: true, state: { autoPrint: true } })
      return
    }

                  ...
                  <table className="w-full min-w-[720px] text-left text-sm">
                    ...
                    <tbody>
                      {filteredSales.length === 0 ? (
                        ...
                        filteredSales.map((s) => (
                          <tr key={s.sale_id} className="border-b border-ink-400/10 last:border-0 dark:border-cream-100/10">
                            ...
                            <td className="py-2.5 pr-3 text-ink-500 dark:text-cream-400">{formatDate(s.due_date)}</td>

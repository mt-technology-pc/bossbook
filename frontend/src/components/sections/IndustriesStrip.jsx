...
export default function IndustriesStrip() {
  return (
    <section className="border-y border-ink-400/10 bg-cream-200/60 py-10">
      <Container>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          {industries.map((item, i) => (
            <Reveal key={item.label} delay={i * 0.05} y={10}>
              <span className="flex items-center gap-2 rounded-full border border-ink-400/15 bg-cream-50 px-4 py-2 text-sm font-medium text-ink-600">

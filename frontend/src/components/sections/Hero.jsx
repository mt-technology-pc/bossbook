  ...
  return (
    <section className="relative overflow-hidden pt-36 pb-24 lg:pt-48 lg:pb-32">
      ...
      <motion.div
        ...
        className="pointer-events-none absolute -top-24 left-1/2 -z-10 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-clay-400/25 blur-3xl animate-blob"
      />
      <motion.div
        aria-hidden
        animate={{ scale: [1, 1.15, 1] }}
        transition={{ duration: 14, repeat: Infinity, ease: 'easeInOut' }}
        className="pointer-events-none absolute top-40 right-[8%] -z-10 h-72 w-72 rounded-full bg-ink-700/10 blur-3xl"
      />
      ...
      <Container className="text-center">
        <motion.div
          ...
          className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-ink-400/20 bg-cream-50/80 px-4 py-1.5 text-xs font-medium text-ink-600 backdrop-blur"
        >
        ...
        <motion.h1
          ...
          className="mx-auto max-w-3xl font-heading text-4xl font-semibold leading-[1.1] tracking-tight text-ink-900 sm:text-5xl lg:text-6xl"
        >
        ...
        <motion.p
          ...
          className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-ink-500 sm:text-lg"
        >
        ...
        >
          <div className="relative rounded-2xl border border-ink-400/15 bg-cream-50 p-3 shadow-2xl shadow-ink-900/10">
            <div className="flex items-center gap-1.5 border-b border-ink-400/10 px-3 pb-3">
            ...
            <div className="grid grid-cols-3 gap-3 p-4 sm:p-6">
              <div className="col-span-2 rounded-xl bg-cream-200 p-5 text-left">
                <p className="text-xs font-medium text-ink-400">Today&apos;s revenue</p>
                <p className="mt-2 font-heading text-3xl font-semibold text-ink-900">
                  Rs. 84,200
                </p>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex-1 rounded-xl bg-cream-200 p-4 text-left">
                  <ScanLine size={16} className="text-clay-500" />
                  <p className="mt-2 text-xs text-ink-400">Units in stock</p>
                  <p className="font-heading text-xl font-semibold text-ink-900">312</p>
                </div>
                <div className="flex-1 rounded-xl bg-cream-200 p-4 text-left">
                  <TrendingUp size={16} className="text-clay-500" />
                  <p className="mt-2 text-xs text-ink-400">Profit margin</p>
                  <p className="font-heading text-xl font-semibold text-ink-900">24.6%</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <motion.div
            ...
            className="absolute -left-6 top-10 hidden w-44 rounded-xl border border-ink-400/15 bg-cream-50 p-3 text-left shadow-xl sm:block"
          >
            <div className="flex items-center gap-2">
              <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-clay-500/15 text-clay-600">
                <Receipt size={14} />
              </span>
              <p className="text-xs font-semibold text-ink-900">Invoice #1042</p>
            </div>
          ...
          <motion.div
            ...
            className="absolute -right-4 bottom-6 hidden w-40 rounded-xl border border-ink-400/15 bg-cream-50 p-3 text-left shadow-xl sm:block"
          >

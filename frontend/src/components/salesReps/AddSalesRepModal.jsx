...
export default function AddSalesRepModal({ open, onClose, onSubmit }) {
  ...
  return (
    <Modal
      ...
      subtitle="Save who's on your sales team so you can attribute invoices and receipts to them."
    >
      {error && (

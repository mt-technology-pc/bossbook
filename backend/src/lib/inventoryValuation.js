// Mirrors frontend/src/lib/inventoryValuation.js exactly (pure JS, no
// browser APIs, safe to run in Node as-is) — the assistant's income
// statement tool needs to compute profit the same way the Income
// Statement report page does, so answers stay reconcilable with what
// the user sees in Reports. Keep this in sync with the frontend copy.
//

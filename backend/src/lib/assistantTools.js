...
const itemSchema = {
  type: Type.OBJECT,
  properties: {
    product_name: { type: Type.STRING, description: 'Product name as the user said it, doesn\'t need to be exact.' },
    quantity: { type: Type.NUMBER },
    unit_price: { type: Type.NUMBER, description: 'Optional — defaults to the product\'s own price if omitted.' },
  },
...
const purchaseItemSchema = {
  ...
  properties: {
    ...
    quantity: { type: Type.NUMBER },
    unit_cost: { type: Type.NUMBER, description: 'Optional — defaults to the product\'s own cost if omitted.' },
    serials: {
      type: Type.ARRAY,
...
export const toolDeclarations = [
  {
    ...
    parameters: {
      type: Type.OBJECT,
      properties: { query: { type: Type.STRING, description: 'Optional name filter, leave empty to list all.' } },
    },
  },
  {
    name: 'list_suppliers',
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        type: { type: Type.STRING, description: '"invoice" or "receipt"' },
        reference: { type: Type.STRING },
        from_date: { type: Type.STRING, description: 'YYYY-MM-DD' },
        to_date: { type: Type.STRING, description: 'YYYY-MM-DD' },
        only_unpaid: { type: Type.BOOLEAN, description: 'Only invoices with an outstanding balance.' },
      },
    },
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        from_date: { type: Type.STRING, description: 'YYYY-MM-DD' },
        to_date: { type: Type.STRING, description: 'YYYY-MM-DD' },
        only_unpaid: { type: Type.BOOLEAN, description: 'Only bills with an outstanding balance.' },
      },
    },
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        reference: { type: Type.STRING, description: 'Optional invoice number, auto-generated if omitted.' },
        notes: { type: Type.STRING },
        sale_date: { type: Type.STRING, description: 'YYYY-MM-DD, defaults to today.' },
        due_date: { type: Type.STRING, description: 'YYYY-MM-DD, defaults to 30 days out.' },
      },
  ...
  },
  {
    ...
    parameters: {
      type: Type.OBJECT,
      properties: {
        customer_name: { type: Type.STRING, description: 'Optional — omit for a walk-in customer.' },
        deposit_account_name: { type: Type.STRING, description: 'Which cash/bank account the money goes into.' },
        items: { type: Type.ARRAY, items: itemSchema },
        reference: { type: Type.STRING },
        notes: { type: Type.STRING },
        sale_date: { type: Type.STRING, description: 'YYYY-MM-DD, defaults to today.' },
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        supplier_name: { type: Type.STRING },
        items: { type: Type.ARRAY, items: purchaseItemSchema },
        reference: { type: Type.STRING },
        notes: { type: Type.STRING },
        bill_date: { type: Type.STRING, description: 'YYYY-MM-DD, defaults to today.' },
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        customer_name: { type: Type.STRING },
        account_name: { type: Type.STRING, description: 'Which cash/bank account the money is deposited to.' },
        amount: { type: Type.NUMBER },
        note: { type: Type.STRING },
        invoice_reference: { type: Type.STRING, description: 'Optional — links the payment to one specific outstanding invoice.' },
      },
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        supplier_name: { type: Type.STRING },
        account_name: { type: Type.STRING, description: 'Which cash/bank account the money is paid from.' },
        amount: { type: Type.NUMBER },
        note: { type: Type.STRING },
        bill_reference: { type: Type.STRING, description: 'Optional — links the payment to one specific outstanding bill.' },
      },
